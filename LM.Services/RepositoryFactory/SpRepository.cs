     ...
     public static SearchPage<T> BindSearchList<T>(Dictionary<string, object> parameters, List<T> records)
        {
            ...
            if (parameters != null)
            {
                if (parameters.ContainsKey(LM.Common.Constants.SearchParameters.PageSize) && parameters.ContainsKey(LM.Common.Constants.SearchParameters.PageStart))
                {
                    size = Convert.ToInt32(parameters[LM.Common.Constants.SearchParameters.PageSize]);
                    from = (Convert.ToInt32(parameters[LM.Common.Constants.SearchParameters.PageStart]) - 1) * size;
                    result.Meta.PageSize = size;
                    result.Meta.Page = Convert.ToInt32(parameters[LM.Common.Constants.SearchParameters.PageStart]);
                }
                else
                {
                    result.Meta.PageSize = size;
        ...
        public static async Task ExecuteStoreProcedureQuery(this LMSSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<string> ExecuteStoreProcedureQueryWithSID(this LMSSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<string> ExecuteStoreProcedure(this LMSSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<string> ExecuteStoreProcedureWithEntitySID(this LMSSpContext catalogDbContext, string sqlQuery, object[] param)
        {
        ...
        public static async Task<Page> ExecutreStoreProcedureResult(this LMSSpContext catalogDbContext, string sqlQuery, object[] param)
        {
            Page page = new Page();
        ...
        public static async Task<Page> ExecutreStoreProcedureResultList(this LMSSpContext catalogDbContext, string sqlQuery, object[] param)
        {
            Page page = new Page();
            var response = await catalogDbContext.Set<ExecutreStoreProcedureResultList>().FromSqlRaw(sqlQuery, param).ToListAsync();
            if (response != null && response.Count > 0)
