    ...
    #region Variables & Constructor
        ...
        protected Dictionary<string, object> FillParamesFromModel(SearchRequestModel searchModel, long userID = 0)
        {
            ...
            if (searchModel != null)
            {
                ...
                parameters.Add(LM.Common.Constants.SearchParameters.SortColumn, sortColumn);
                ...
                parameters.Add(LM.Common.Constants.SearchParameters.SortOrder, sortOrder);
                ...
                parameters.Add(LM.Common.Constants.SearchParameters.SearchText, searchText);
                ...
                if (!string.IsNullOrWhiteSpace(searchModel.Filters))
                {
                    ...
                    parameters.Add(LM.Common.Constants.SearchParameters.Filters, filter.Trim());
                }
                else
                {
                    parameters.Add(LM.Common.Constants.SearchParameters.Filters, "1 = 1 AND");
                }
            }
            ...
            parameters.Add(LM.Common.Constants.SearchParameters.PageStart, pageStart);
            parameters.Add(LM.Common.Constants.SearchParameters.PageSize, pageSize);
